...
import com.example.chester11206.testapp.R;
import com.example.chester11206.testapp.retrofit.OAuthServerIntf;
import com.example.chester11206.testapp.retrofit.RetrofitBuilder;
import com.example.chester11206.testapp.transverse.model.OAuthToken;
...
public class LoginActivity extends AppCompatActivity {
    ...
    **********************************************************/
     ...
     */
    private static final String CLIENT_ID = "328022909708-mt374vu9dglnr0sd434tha6tsmllldrq.apps.googleusercontent.com";
    /**
     * The redirect uri you have define in your google console for your project
     */
    private static final String REDIRECT_URI = "com.example.chester11206.testapp:/oauth2redirect";
    /**
     ...
     */
    private static final String REDIRECT_URI_ROOT = "com.example.chester11206.testapp";
    /**
     ...
     */
    public static final String API_SCOPE = "https://www.googleapis.com/auth/fitness.activity.read https://www.googleapis.com/auth/fitness.activity.write https://www.googleapis.com/auth/fitness.body.read https://www.googleapis.com/auth/fitness.body.write https://www.googleapis.com/auth/fitness.location.read https://www.googleapis.com/auth/fitness.location.write https://www.googleapis.com/auth/fitness.nutrition.read https://www.googleapis.com/auth/fitness.nutrition.write";
    ...
    private void makeAuthorizationRequest() {
        ...
        String newurl = String.valueOf(authorizeUrl.url()).replace("%20", "+");
        Log.e(TAG, "the url is : " + newurl);
